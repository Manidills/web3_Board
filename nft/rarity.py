...
import json
import itertools
from Apis.quicknode import get_nft_details
...
def rarity():
    ...
    if selected_contract != default_item:
        ...
        st.subheader("Rare_NFTS_In_The_Collection")
        try:st.dataframe(get_nft_details(str(selected_contract_address))['result']['tokens'])
        except:pass